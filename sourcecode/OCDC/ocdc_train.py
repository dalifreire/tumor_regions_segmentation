...
def train_model_with_validation(dataloaders,
    ...
    augmentation = augmentation_strategy if augmentation_strategy == "no_augmentation" else "{}_{}_operations".format(augmentation_strategy, len(augmentation_operations)-1)
...
if __name__ == '__main__':
    ...
    augmentation_strategy = "one_by_epoch" # "no_augmentation", "one_by_epoch", #"random",
    augmentation = [None,
                    "horizontal_flip",
                    "vertical_flip",
                    "rotation",
                    ...
                    "grid_distortion",
                    "optical_distortion"]
    #[None, "horizontal_flip", "vertical_flip", "rotation", "transpose", "elastic_transformation", "grid_distortion", "optical_distortion"]
