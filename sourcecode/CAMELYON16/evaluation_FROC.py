...
def computeFROC(FROC_data):
    ...
    print("\n\n")
    print("#################")
    print("Probabilidades FP: {}".format(unlisted_FPs))
    print("Probabilidades TP: {}".format(unlisted_TPs))

    total_FPs, total_TPs = [], []
    all_probs = sorted(set(unlisted_FPs + unlisted_TPs))
    print("Probabilidades sem repetições: {}".format(all_probs))
    print("Total de regiões tumorais: {}".format(sum(FROC_data[3])))
    ...
    print("Soma FP: {}".format(total_FPs))
    print("Soma TP: {}".format(total_TPs))
    print("#################")
    print("\n\n")
