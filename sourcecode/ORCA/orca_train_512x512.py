...
if __name__ == '__main__':
    ...
    trained_model_version = "ORCA_512x512__Size-512x512_Epoch-213_Images-100_Batch-1__color_augmentation"
    ...
    # train the model
    result_file_csv = "../../datasets/ORCA_512x512/training/orca_training_accuracy_loss_color.csv"
