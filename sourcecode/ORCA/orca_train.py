...
if __name__ == '__main__':
    ...
    trained_model_version = "ORCA__Size-640x640_Epoch-51_Images-4181_Batch-1__no_augmentation"
    ...
    # train the model
    result_file_csv = "../../datasets/ORCA/training/orca_training_accuracy_loss_noaugmentation.csv"
